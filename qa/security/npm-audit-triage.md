...
> **Update (2026-07-04):** Playwright findings (rows 1–2) remediated on branch `fix/playwright-audit-remediation` — `@playwright/test@1.61.1`, `playwright@1.61.1`. See `qa/security/playwright-remediation-result.md`.
...
|---------|-------------------|-------|
| Playwright SSL (×2 audit nodes) | ~~Bump `@playwright/test` to `>=1.55.1`~~ **Done** (`1.61.1` on `fix/playwright-audit-remediation`) | **Composer** |
