...
function createProvider(): EmailDeliveryProvider {
  return {
    diagnostic: vi.fn(() => ({
      ...
      allowlistCount: 1,
      apiKeyPresent: true,
      brevoApiKeyRedacted: "test…-key",
      configured: true,
      configuredTestRecipientEmail: "qa@example.com",
      demoStartForcedSimulation: false,
      emailDeliveryProvider: "brevo",
      gmailConfigured: false,
      missing: [],
      outlookConfigured: false,
      outreachDeliveryProvider: "brevo",
      provider: "brevo" as const,
      publicBaseUrlConfigured: true,
      realSendEnabled: true,
      replyToConfigured: true,
      runtimeStartupMode: "dev-env-brevo",
      sandboxMode: false,
