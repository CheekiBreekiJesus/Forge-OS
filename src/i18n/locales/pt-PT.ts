...
export const dictionary: Dictionary = {
  ...
  leadops: {
    eyebrow: "Operacoes de leads outbound",
    title: "Painel LeadOps",
    description:
      "Reveja leads importados, progresso de campanhas e estado de outreach para o tenant demo. Os dados sao sinteticos e isolados por tenant.",
    backToDashboard: "Voltar ao LeadOps",
    searchPlaceholder: "Pesquisar empresa, contacto, email, localizacao, origem ou website",
    clearFilters: "Limpar filtros",
    resultCount: "{count} leads visiveis",
    addToCampaign: "Adicionar a campanha",
    addToCampaignDisabled: "A atribuicao a campanhas esta desativada neste incremento demo.",
    selectAllVisible: "Selecionar todos os visiveis",
    emptyTitle: "Ainda nao existem leads importados",
    ...
    detailDescription: "Placeholder minimo para o proximo incremento de detalhe e compositor de email LeadOps.",
    detailPlaceholder: "Compositor de email, linha temporal e atribuicao a campanhas serao adicionados num incremento posterior.",
    sections: {
    ...
    activities: {
      ...
      "campaign-assigned": "Campanha atribuida",
      "message-queued": "Mensagem em fila",
      "message-sent": "Mensagem enviada",
      "metrics-updated": "Metricas atualizadas"
    },
    detailFields: {
      company: "Empresa",
      contact: "Contacto",
    ...
    detailWorkspace: {
      ...
      sequencePanel: "Preview da sequencia",
      activityPanel: "Linha temporal",
      importSummary: "Resumo da fonte de dados",
      noWebsiteContext: "Sem contexto de website disponivel",
      websiteContextAvailable: "Contexto de website disponivel",
      personalizationWarning: "Personalizacao limitada: nao afirmar revisao de website sem contexto.",
      ...
      manualProductReason: "Produto disponivel para selecao manual."
    },
    providerStates: {
      not_ready: "Nao preparado",
      draft: "Rascunho",
      approved: "Aprovado",
      queued: "Em fila",
      sent: "Enviado",
