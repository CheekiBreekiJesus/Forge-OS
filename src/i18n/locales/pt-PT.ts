...
export const dictionary: Dictionary = {
  ...
  settings: {
    ...
    integrations: {
      ...
      provider: {
        title: "Diagnostico de envio de email",
        description:
          "Inspecione a configuracao server-side do fornecedor de email e envie um email de auto-teste para um endereco permitido. Segredos nunca aparecem no browser.",
        ...
        provider: "Fornecedor ativo",
        emailDeliveryProvider: "EMAIL_DELIVERY_PROVIDER",
        outreachDeliveryProvider: "OUTREACH_DELIVERY_PROVIDER",
        configured: "Configurado",
        realSend: "OUTREACH_REAL_SEND_ENABLED",
        testSend: "OUTREACH_TEST_SEND_ENABLED",
        apiKey: "BREVO_API_KEY presente",
        apiKeyRedacted: "BREVO_API_KEY (redigida)",
        senderEmail: "Email do remetente",
        senderName: "Nome do remetente",
        sender: "Remetente configurado",
        allowlist: "Destinatarios de teste permitidos",
        gmail: "Fornecedor Gmail",
        outlook: "Fornecedor Outlook",
        notConfiguredYet: "Ainda nao configurado",
        yes: "Sim",
        no: "Nao",
        missing: "Em falta",
        warnings: "Avisos",
        selfTestTitle: "Enviar email de teste para mim",
        selfTestDescription:
          "Escreva manualmente um destinatario permitido. Destinatarios de campanha nunca sao usados neste envio de diagnostico.",
        recipientEmail: "Email do destinatario",
        subject: "Assunto",
        messageBody: "Corpo da mensagem",
        confirmation: "Escreva SEND SELF TEST para confirmar",
        sendSelfTest: "Enviar email de auto-teste",
        sending: "A enviar auto-teste...",
        savedLocally: "Resultado do auto-teste guardado localmente em eventos do fornecedor e tentativas de envio.",
        resultAccepted: "Auto-teste aceite pelo fornecedor.",
      ...
      outreachTestProfile: {
        ...
        showcaseImageReference: "Caminho ou URL HTTPS da imagem de exemplos",
        companyLogoReference: "Caminho ou URL HTTPS do logotipo",
        footerCtaLabel: "Texto do CTA no rodape",
        footerCtaUrl: "URL do CTA no rodape",
