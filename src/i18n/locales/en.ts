  ...
  settings: {
    ...
    integrations: {
      ...
      provider: {
        ...
        description:
          "Inspect server-side email provider configuration and send a single self-test email to an allowlisted address. Secrets are never shown in the browser.",
        ...
        apiKey: "BREVO_API_KEY present",
        apiKeyRedacted: "BREVO_API_KEY (redacted)",
        ...
        missing: "Missing",
        warnings: "Warnings",
        selfTestTitle: "Send test email to myself",
        selfTestDescription:
          "Type an allowlisted recipient manually. Campaign recipients are never used for this diagnostic send.",
        recipientEmail: "Recipient email",
        subject: "Subject",
        messageBody: "Message body",
        confirmation: "Type SEND SELF TEST to confirm",
        sendSelfTest: "Send self-test email",
        sending: "Sending self-test...",
        savedLocally: "Self-test result saved to local provider events and send attempts.",
        resultAccepted: "Self-test accepted by provider.",
      ...
      outreachTestProfile: {
        ...
        showcaseImageReference: "Showcase image path or HTTPS URL",
        companyLogoReference: "Company logo path or HTTPS URL",
        footerCtaLabel: "Footer CTA label",
        footerCtaUrl: "Footer CTA URL",
